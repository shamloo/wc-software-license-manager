	...
	<div class="options_group show_if_downloadable">
		...
		<div <?php echo $wc_slm_display; ?> class="wc-slm-toggled-hide">
			<p class="form-field">
				...
				<span class="woocommerce-help-tip" data-tip="<?php _e( 'Enter the number of years for the Renewal Period. Enter 0 (zero) or leave blank for lifetime renewals.', 'wc-slm' );?>"></span>
			</p>
			<p class="form-field">
